...
public class MockServlet extends HttpServlet {
	...
	private void handleArrivalRequest(HttpServletResponse resp, String message) throws IOException {
	...
	private void handleShippingRequest(HttpServletResponse resp, String message) throws IOException {
