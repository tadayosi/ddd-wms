...
public class BeanTest {
    ...
    public void testArrivalRequest() throws Exception {
        ...
        Date date = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS")
                .parse("2010/06/25 10:50:51.111");

        String jsonMessage = "{\"time\":"
                + date.getTime()
                + ",\"items\":[{\"amount\":3,\"id\":4},{\"amount\":2,\"id\":3},{\"amount\":5,\"id\":4}]}";
        ArrivalRequestMessageBean bean = JSON.decode(jsonMessage,
